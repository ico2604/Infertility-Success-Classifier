# =========================================================
# CatBoost Fixed Params + IVF Signal + Combo Feature v7
# ---------------------------------------------------------
# 목적
# 1) catboost_optuna_v4_light에서 찾은 best params를 고정하여 사용한다.
# 2) 기존 전처리 / 파생변수 흐름을 그대로 유지한다.
# 3) IVF 전용 signal 파생변수 3개를 추가한다.
# 4) CatBoost 전용 combo feature 3개를 추가한다.
# 5) Stratified K-Fold OOF 방식으로 성능을 검증한다.
# 6) OOF / submission / feature importance / threshold 분석을 저장한다.
# =========================================================
...
EXPERIMENT_NAME = "catboost_optuna_fixed_v7_ivf_combo"
...
log_path = os.path.join(OUTPUT_DIR, "catboost_optuna_fixed_v7_results_log.csv")
log_row = {
...
#     폴드         AUC   Best Iter
# ----------------------------------
# Fold  1    0.738678        1237
# Fold  2    0.742921        1610
# Fold  3    0.740405        1959
# Fold  4    0.738561        1238
# Fold  5    0.740823        1563
# ----------------------------------
#   Mean    0.740278
#    Std    0.001600
