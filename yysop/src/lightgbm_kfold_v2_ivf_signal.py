# =========================================================
# LightGBM Stratified K-Fold Validation v2
# ---------------------------------------------------------
# 목적
# 1) train/test 데이터를 불러온다.
# 2) XGBoost v2 / CatBoost v2와 동일한 기본 수치 변환을 수행한다.
# 3) 동일한 의료 도메인 파생변수를 생성한다.
# 4) IVF 전용 signal 파생변수 3개를 추가한다.
# 5) LightGBM용 범주형 인코딩을 수행한다.
...
# # 기존
# SEED = 42
# EXPERIMENT_NAME = "lightgbm_ivf_signal_v2"

# # seed 42 버전 (그대로)
# SEED = 42
# EXPERIMENT_NAME = "lightgbm_ivf_signal_seed42"

# # seed 2024 버전
# SEED = 2024
# EXPERIMENT_NAME = "lightgbm_ivf_signal_seed2024"

# # seed 777 버전
# SEED = 777
# EXPERIMENT_NAME = "lightgbm_ivf_signal_seed777"
...
log_path = os.path.join(OUTPUT_DIR, "lightgbm_v2_results_log.csv")
