...
SEARCH_RESULT_PATH = os.path.join(OUTPUT_DIR, "ensemble_v6_rank_search_results_v17_plus_light.csv")
...
EXPERIMENT_NAME = "ensemble_v6_rank_ensemble_xgb_lgb_cat2_v17_plus_light"
